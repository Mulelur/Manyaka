...
import img from "../../assets/Confidence.jpg";
import { AboutMe } from "../../components";
import { DownloadCVButton } from "../../components/buttons";
import cv from "../../assets/cv/confidence.pdf";
import letter from "../../assets/cv/confidence_letter.pdf";
    ...
    <AboutMe>
      <AboutMe.Container>
        ...
        <AboutMe.Column>
          ...
          <AboutMe.Heading4>
            Hello! My Name is Confidence Manyaka .
          </AboutMe.Heading4>
          <AboutMe.Text>
